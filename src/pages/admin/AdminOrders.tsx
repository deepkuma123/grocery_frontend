                                    ...
                                    <tr key={order.id} className="hover:bg-zinc-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button 
                                                ...
                                                className="px-3 py-1.5 text-xs font-medium bg-zinc-100 text-zinc-700 rounded-lg hover:bg-zinc-200 transition-colors inline-flex items-center gap-1.5"
                                            >
                                                <EyeIcon className="size-3" /> View Items
                                            </button>
                                        </td>
                                    </tr>
                                ))
