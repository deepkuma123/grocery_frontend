...
const OrderTracking = () => {
    ...
    useEffect(() => {
        ...
        const socketURL = import.meta.env.VITE_BASE_URL ? import.meta.env.VITE_BASE_URL.replace("/api", "") : "http://localhost:5000";
        ...
        socket.on("locationUpdate", (data) => {
            console.log("Received live location Update via Socket:", data);
                        ...
                        <div className="bg-white rounded-2xl p-5">
                            ...
                            {order?.deliveryTimeSlot && (
                                <div className="mt-4 pt-4 border-t border-app-green/10">
                                    <h4 className="text-xs font-semibold text-app-text-light mb-1">Requested Delivery Time</h4>
                                    <p className="text-sm font-medium text-app-green">{order.deliveryTimeSlot}</p>
                                </div>
                            )}
                        </div>
