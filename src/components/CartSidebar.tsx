                ...
                <div className="flex-1 overflow-y-auto p-5 space-y-4">
                    {items.length === 0 ? (
                        ...
                        items.map((item) => {
                            ...
                            return (
                                <div key={item.product.id + (item.variantId || "")} className="flex gap-3 bg-app-cream/60 rounded-xl p-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            <div className="flex items-center gap-1.5">
                                                <button onClick={() => updateQuantity(item.product.id, item.quantity - 1, item.variantId)} className="size-7 rounded-lg bg-white border border-app-border flex-center">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button onClick={() => removeFromCart(item.product.id, item.variantId)} className="p-1 text-app-text-light hover:text-app-error transition-colors">
